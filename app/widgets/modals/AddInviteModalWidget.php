...
use app\assets\NewInviteWidgetAsset;
...
class AddInviteModalWidget extends BaseModalWidget
{
    ...
    public $selectStoreName = 'store';
    public $selectStorePrompt = 'Choose a Store';
    public $selectStoreItems = [];
    public $selectStoreErrorMsg = 'Please choose a Store';

    public function init()
    {
        NewInviteWidgetAsset::register($this->view);
    }
    ...
    public function renderContents()
    {
        ...
        echo Html::tag('span', $this->selectErrorMsg, ['class' => 'help-block new-invite__error hide', 'id' => 'newInviteSelectError']);
        ...
        echo Html::label('Store');
        echo Html::dropDownList($this->selectStoreName, '', $this->selectStoreItems,
            ['class' => 'form-control', 'prompt' => $this->selectStorePrompt, 'id' => 'newInviteSelectStore']);
        echo Html::tag('span', $this->selectStoreErrorMsg,
            ['class' => 'help-block new-invite__error hide', 'id' => 'newInviteSelectStoreError']);
